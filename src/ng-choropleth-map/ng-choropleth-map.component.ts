...
@Component({
  selector: 'app-ng-choropleth-map',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './ng-choropleth-map.component.html',
  styleUrl: './ng-choropleth-map.component.css',
})
export class NgChoroplethMapComponent implements OnInit {
  @Input() data: any[] = [];
